...
describe('singlyLinkedList_Tests_', () => {
  ...
  describe('find_Tests_', () => {
    ...
    test('find_ValueExistsInList_Return', () => {
      ...
      let existingNodeInList = singlyLinkedList.findAt(randomPickIndex) as SinglyLinkedListNode<string>;
  ...
  describe('findAt_Tests_', () => {
    ...
    test('findAt_Index_Return', () => {
      ...
      populateTestNodes();
      const size = singlyLinkedList['size'];
      const indexToFind = faker.datatype.number(
        { min: 0,
        max: size - 1 });
      ...
      // act
      const result = singlyLinkedList.findAt(indexToFind) as SinglyLinkedListNode<string>;
  ...
  describe('removeAt_Tests_', () => {
    ...
    test('removeAt_Index_Return', () => {
      ...
      const indexToRemoveAt = faker.datatype.number(
        { min: 0,
        max: oldSize - 1 });
      const nodeAtIndexToRemove = singlyLinkedList.findAt(indexToRemoveAt) as SinglyLinkedListNode<string>;
      ...
      expect(singlyLinkedList.findAt(indexToRemoveAt)).toEqual(nodeAtIndexToRemove.next);
    });
